                ...
                <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                    <div class="relative">
                        ...
                        <div class="relative group">
                            ...
                            <input id="pasien_search" type="text" autocomplete="off" placeholder="Ketik No. RM atau Nama Pasien..."
                            ...
                            <input type="hidden" name="pasien_id" id="pasien_id_hidden" value="<?= htmlspecialchars($formReservasi['pasien_id'] ?? '') ?>" required>
                        </div>

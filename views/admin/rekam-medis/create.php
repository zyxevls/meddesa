<section class="mx-auto max-w-7xl space-y-6">
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-600 via-cyan-700 to-blue-800 p-7 text-white shadow-xl">
        ...
        <div class="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                <p class="text-xs font-semibold uppercase tracking-[0.3em] text-cyan-100">Tambah Rekam Medis</p>
                <h1 class="mt-1 text-3xl font-bold leading-tight md:text-4xl">Tambah Data Rekam Medis Baru</h1>
                <p class="mt-2 max-w-2xl text-sm text-blue-100 md:text-base">Isi formulir berikut untuk mencatat data pemeriksaan dan diagnosis pasien di sistem.</p>
            </div>
    ...
    <div class="grid gap-6 lg:grid-cols-[3fr_1fr]">
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <form method="POST" action="/admin/rekam-medis/store" class="space-y-8">
                    ...
                    <div class="grid gap-4 md:grid-cols-3">
                        ...
                        <div class="relative searchable-select" data-required-message="Reservasi Belum Dipilih|Silakan cari dan pilih reservasi dari daftar yang tersedia.">
                            ...
                            <div class="relative group">
                                ...
                                <input type="hidden" name="reservasi_id" id="reservasi_id_hidden" data-role="hidden-input" required>
                            </div>
                        ...
                        <div class="relative searchable-select" data-required-message="Pasien Belum Dipilih|Silakan cari dan pilih pasien dari daftar yang tersedia.">
                            ...
                            <div class="relative group">
                                <i class="fas fa-search absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none group-focus-within:text-cyan-500 transition-colors"></i>
                                <input id="pasien_search" data-role="search-input" type="text" autocomplete="off" placeholder="Ketik No. RM atau Nama Pasien..." class="w-full rounded-xl border border-slate-300 bg-slate-50 pl-11 pr-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                                <input type="hidden" name="pasien_id" id="pasien_id_hidden" data-role="hidden-input" required>
                            </div>
                            <div id="pasien_result_dropdown" data-role="result-dropdown" class="absolute z-50 mt-2 w-full max-h-60 overflow-y-auto rounded-xl border border-slate-200 bg-white p-2 shadow-xl hidden">
                        ...
                        <div class="relative searchable-select" data-required-message="Dokter Belum Dipilih|Silakan cari dan pilih dokter dari daftar yang tersedia.">
                            ...
                            <div class="relative group">
                                <i class="fas fa-search absolute left-4 top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none group-focus-within:text-cyan-500 transition-colors"></i>
                                <input id="dokter_search" data-role="search-input" type="text" autocomplete="off" placeholder="Ketik Nama Dokter..." class="w-full rounded-xl border border-slate-300 bg-slate-50 pl-11 pr-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                                <input type="hidden" name="dokter_id" id="dokter_id_hidden" data-role="hidden-input" required>
                            </div>
                        ...
                        <div>
                            ...
                            <input id="tanggal_periksa" name="tanggal_periksa" type="datetime-local" required value="<?= date('Y-m-d\TH:i') ?>" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4">
                        <div>
                            ...
                            <textarea id="keluhan_utama" name="keluhan_utama" placeholder="Keluhan utama pasien saat datang..." rows="4" required class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"></textarea>
                        </div>
                        <div>
                            <label for="pemeriksaan_fisik" class="mb-2 block text-sm font-semibold text-slate-700">Pemeriksaan Fisik</label>
                            <textarea id="pemeriksaan_fisik" name="pemeriksaan_fisik" placeholder="Hasil pemeriksaan fisik (TD, RR, HR, Suhu, dll)..." rows="4" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4">
                        <div>
                            ...
                            <textarea id="diagnosa" name="diagnosa" placeholder="Diagnosa/hasil dari pemeriksaan..." rows="4" required class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"></textarea>
                        </div>
                        <div>
                            <label for="tindakan" class="mb-2 block text-sm font-semibold text-slate-700">Tindakan</label>
                            <textarea id="tindakan" name="tindakan" placeholder="Tindakan/terapi yang diberikan..." rows="4" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div>
                        ...
                        <textarea id="catatan_dokter" name="catatan_dokter" placeholder="Catatan/observasi tambahan dari dokter..." rows="3" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100"></textarea>
                    </div>
                </div>
        ...
        <aside class="space-y-4">
            <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <div class="mt-4 rounded-xl bg-slate-50 p-4 text-sm text-slate-700">
                    ...
                    <ul class="mt-2 space-y-1">
                        <li class="flex items-start gap-2"><i class="fas fa-check-circle mt-1 text-emerald-500"></i><span>Pilih pasien & dokter yang tepat.</span></li>
            ...
            <div class="rounded-2xl border border-cyan-200 bg-gradient-to-br from-cyan-50 to-blue-50 p-5 shadow-sm">
                ...
                <p class="mt-2 text-sm text-slate-700">Pasien, Dokter, Keluhan Utama, Diagnosa, dan Tanggal Periksa wajib diisi.</p>
            </div>
        </aside>
    </div>
</section>

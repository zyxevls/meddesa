                ...
                <div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input id="nama" name="nama" type="text" value="<?= htmlspecialchars($formPasien['nama'] ?? '') ?>" required placeholder="Contoh: Budi Santoso" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div>
                            ...
                            <input id="tempat_lahir" name="tempat_lahir" type="text" value="<?= htmlspecialchars($formPasien['tempat_lahir'] ?? '') ?>" required placeholder="Contoh: Jakarta" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="tanggal_lahir" class="mb-2 block text-sm font-semibold text-slate-700">Tanggal Lahir</label>
                            <input id="tanggal_lahir" name="tanggal_lahir" type="date" value="<?= htmlspecialchars($formPasien['tanggal_lahir'] ?? '') ?>" required class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <div>
                            ...
                            <input id="no_kk" name="no_kk" type="text" value="<?= htmlspecialchars($formPasien['no_kk'] ?? '') ?>" required placeholder="Contoh: 3201XXXXXXXXXXXX" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                    </div>
                </div>

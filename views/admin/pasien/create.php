<section class="mx-auto max-w-7xl space-y-6">
    <div class="relative overflow-hidden rounded-3xl bg-gradient-to-r from-teal-600 via-cyan-700 to-blue-800 p-7 text-white shadow-xl">
        ...
        <div class="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
                ...
                <h1 class="mt-1 text-3xl font-bold leading-tight md:text-4xl">Tambah Data Pasien Baru</h1>
                <p class="mt-2 max-w-2xl text-sm text-blue-100 md:text-base">Isi formulir berikut untuk menambahkan pasien ke sistem pelayanan klinik.</p>
            </div>
    ...
    <div class="grid gap-6 lg:grid-cols-[3fr_1fr]">
        <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
            <form method="POST" action="/admin/pasien/store" class="space-y-8">
                <div>
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div>
                            ...
                            <input id="no_rm" name="no_rm" type="text" required placeholder="Contoh: RM-2026-001" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="nik" class="mb-2 block text-sm font-semibold text-slate-700">NIK</label>
                            <input id="nik" name="nik" type="text" required placeholder="Contoh: 3201XXXXXXXXXXXX" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="no_bpjs" class="mb-2 block text-sm font-semibold text-slate-700">No BPJS</label>
                            <input id="no_bpjs" name="no_bpjs" type="text" required placeholder="Contoh: 0001234567890" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="nama" class="mb-2 block text-sm font-semibold text-slate-700">Nama Lengkap</label>
                            <input id="nama" name="nama" type="text" required placeholder="Contoh: Budi Santoso" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                    </div>
                </div>
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div>
                            ...
                            <input id="tempat_lahir" name="tempat_lahir" type="text" required placeholder="Contoh: Jakarta" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="tanggal_lahir" class="mb-2 block text-sm font-semibold text-slate-700">Tanggal Lahir</label>
                            <input id="tanggal_lahir" name="tanggal_lahir" type="date" required class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="jenis_kelamin" class="mb-2 block text-sm font-semibold text-slate-700">Jenis Kelamin</label>
                            <select id="jenis_kelamin" name="jenis_kelamin" required class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                ...
                <div class="border-t border-slate-200 pt-7">
                    ...
                    <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        <div>
                            ...
                            <input id="no_telephone" name="no_telephone" type="text" required placeholder="Contoh: 081234567890" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                            <label for="pekerjaan" class="mb-2 block text-sm font-semibold text-slate-700">Pekerjaan</label>
                            <input id="pekerjaan" name="pekerjaan" type="text" required placeholder="Contoh: Petani" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input id="no_kk" name="no_kk" type="text" required placeholder="Contoh: 3201XXXXXXXXXXXX" class="w-full rounded-xl border border-slate-300 bg-slate-50 px-4 py-3 text-slate-700 outline-none transition focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-100">
                        </div>
                    </div>
                </div>
